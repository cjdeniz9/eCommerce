...
Public Class ProductDetail
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Request.QueryString("ProductID") <> "" Then
            ...
            If drProduct.Read() Then
                lblProductNo.Text = Trim(drProduct.Item("ProductNo"))
                ...
                imgProduct.ImageUrl = "img/products/" + Trim(drProduct.Item("ProductID")) + ".jpg"
                If Session("Customer") <> "" Then
                    lblPrice.Text = drProduct.Item("UnitPrice") * 0.9
                Else
                    lblPrice.Text = drProduct.Item("UnitPrice")
                End If
                For intRating As Integer = 1 To drProduct("Rating")
                    strRating += "<img src='img/products/1star.jpg' width='15px'>"
                Next
    ...
    Private Sub btnAddtoCart_Click(sender As Object, e As EventArgs) Handles btnAddtoCart.Click
        ...
        If drCheck.Read() Then
            ' updat the quantity
            strSQLStatement = "UPDATE cart set Quantity = " & CInt(tbQuantity.Text) & " where ProductNo = '" & Trim(lblProductNo.Text) & "'"
        Else
